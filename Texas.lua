...
local UserName = (data.username_ or "cqqcqq")
local NameUser = "[- Texas 𝖲𝗈𝗎𝗋𝖼𝖾 .](https://t.me/cqqcqq)\n — — — — — — — — —\n⌔︙بواسطه -› ["..data.first_name_.."](T.me/"..UserName..")"
local NameUserr = "[- Texas 𝖲𝗈𝗎𝗋𝖼𝖾 .](https://t.me/cqqcqq)\n — — — — — — — — —\n⌔︙اسم المستخدم -› ["..data.first_name_.."](T.me/"..UserName..")"
if status == "lock" then
...
send(msg.chat_id_, msg.id_,"[- Texas 𝖲𝗈𝗎𝗋𝖼𝖾 .](https://t.me/cqqcqq)\n — — — — — — — — —\n⌔︙العضو -› ["..data.first_name_.."](t.me/"..(data.username_ or "cqqcqq")..")".."\n⌔︙تم رفعه "..RTPA.." هنا\n")
...
if Texasrt == "مميز" and Addictive(msg) then
send(msg.chat_id_, msg.id_,"[- Texas 𝖲𝗈𝗎𝗋𝖼𝖾 .](https://t.me/cqqcqq)\n — — — — — — — — —\n⌔︙العضو -› ["..result.title_.."](t.me/"..(text1[3] or "cqqcqq")..")".."\n⌔︙تم رفعه "..text1[2].." هنا")   
database:sadd(bot_id.."Texas:Special:User"..msg.chat_id_,result.id_)  
...
local UserName = (b.username_ or "cqqcqq")
...
keyboard = {} 
keyboard.inline_keyboard = {
{{text = '- Texas TeAM .',url="t.me/cqqcqq"}},
}
local msg_id = msg.id_/2097152/0.5
...
inline = {
{{text = '⌔︙ Texas 𝖲𝗈𝗎𝗋𝖼𝖾  .',url='http://t.me/cqqcqq'}},
}
...
inline = {
{{text = '⌔︙ Texas 𝖲𝗈𝗎𝗋𝖼??  .',url='http://t.me/cqqcqq'}},
}
https.request("https://api.telegram.org/bot"..token.."/deleteMessage?chat_id="..Chat_id.."&message_id="..msg_idd)
send_inlin_key(Chat_id,Text,inline)
