...
>> The Bot is Running
>> Bot source > Texas
>>Source channel > @ccqcqq
>>Source developer > @DaYeSk
...
if hash or Bot(msg) or DevTexas(msg) or VIP_DeV(msg) then    
return true  
else  
return false  
end  
...
if hash or DevBot(msg) or DevTexas(msg) or VIP_DeV(msg) then    
return true 
else 
return false 
end 
...
if hash or Bot(msg) or DevTexas(msg) or DevBot(msg) or VIP_DeV(msg) or creatorA(msg) then     
return true 
else 
return false 
end 
...
if hash or Bot(msg) or DevTexas(msg) or DevBot(msg) or BasicConstructor(msg) or VIP_DeV(msg) or creatorA(msg) then             
return true    
else    
return false    
end 
...
if hash or Bot(msg) or DevTexas(msg) or DevBot(msg) or BasicConstructor(msg) or Constructor(msg) or VIP_DeV(msg) or creatorA(msg) then             
return true    
else    
return false    
end 
...
if hash or Bot(msg) or DevTexas(msg) or DevBot(msg) or BasicConstructor(msg) or Constructor(msg) or Owner(msg) or VIP_DeV(msg) or creatorA(msg) then             
return true    
else    
return false    
end 
...
local hash = database:sismember(bot_id.."Texas:MN:TF"..msg.chat_id_,msg.sender_user_id_)    
if hash or Bot(msg) or DevTexas(msg) or DevBot(msg) or BasicConstructor(msg) or VIP_DeV(msg) or creatorA(msg) then             
return true    
else    
return false    
...
if hash or Bot(msg) or  DevTexas(msg) or DevBot(msg) or BasicConstructor(msg) or Constructor(msg) or Owner(msg) or Addictive(msg) or VIP_DeV(msg) or creatorA(msg) then             
return true 
else 
return false 
end 
...
var = true
elseif DevTexas(user_id) == true then
var = true
...
if tonumber(user_id) == tonumber(1808074603) then  
var = true  
elseif tonumber(user_id) == tonumber(1808074603) then
var = true  
...
elseif tonumber(user_id) == tonumber(1808074603) then  
var = "مطور السورس"  
elseif DevTexase(user_id) == true then
var = "المطور الاساسي"  
elseif tonumber(user_id) == tonumber(bot_id) then  
var = "البوت"
...
elseif database:sismember(bot_id.."Texas:MN:TF"..chat_id, user_id) then
var =  "منظف"  
elseif database:sismember(bot_id.."Texas:Special:User"..chat_id, user_id) then  
...
local UserName = (data.username_ or "ccqcqq")
local NameUser = "[- Texas 𝖲𝗈𝗎𝗋𝖼𝖾 .](https://t.me/ccqcqq)\n — — — — — — — — —\n⌔︙بواسطه -› ["..data.first_name_.."](T.me/"..UserName..")"
local NameUserr = "[- Texas 𝖲𝗈𝗎𝗋𝖼𝖾 .](https://t.me/ccqcqq)\n — — — — — — — — —\n⌔︙اسم المستخدم -› ["..data.first_name_.."](T.me/"..UserName..")"
if status == "lock" then
...
local Texas_Msg = database:sismember(bot_id.."Texas:List:Filter:text"..msg.chat_id_,text) 
if Texas_Msg then    
...
if msg.content_.ID == 'MessageAnimation' and not Vips(msg) then      
local geAni = database:sismember(bot_id.."Texas:List:Filter:Animation"..msg.chat_id_,msg.content_.animation_.animation_.persistent_id_) 
if geAni then        
...
if msg.content_.ID == 'MessageSticker' and not Vips(msg) then      
local ker = database:sismember(bot_id.."Texas:List:Filter:Sticker"..msg.chat_id_,msg.content_.sticker_.sticker_.persistent_id_) 
if ker then        
...
if msg.content_.ID == 'MessagePhoto' and not Vips(msg) then      
local phh = database:sismember(bot_id.."Texas:List:Filter:Photo"..msg.chat_id_,msg.content_.photo_.sizes_[1].photo_.persistent_id_) 
if phh then        
...
database:set(bot_id.."Texas:Lock:Xn"..msg.chat_id_,"del")  
...
database:del(bot_id.."Texas:Lock:Xn"..msg.chat_id_)  
...
if text == ("الثانويين") and DevTexas(msg) then
...
if result.id_ == tonumber(1808074603) then
...
if userid == tonumber(1808074603) then
send(msg.chat_id_, msg.id_, "⌔︙لا يمكن { حظر،كتم،طرد،تقيد،الخ ..} مطور السورس \n")
return false 
end
if userid == tonumber(1808074603) then
...
send(msg.chat_id_, msg.id_,"[- Texas 𝖲𝗈𝗎𝗋𝖼𝖾 .](https://t.me/ccqcqq)\n — — — — — — — — —\n⌔︙العضو -› ["..data.first_name_.."](t.me/"..(data.username_ or "ccqcqq")..")".."\n⌔︙تم رفعه "..RTPA.." هنا\n")
...
if Texasrt == "مميز" and Addictive(msg) then
send(msg.chat_id_, msg.id_,"[- Texas 𝖲𝗈𝗎𝗋𝖼𝖾 .](https://t.me/ccqcqq)\n — — — — — — — — —\n⌔︙العضو -› ["..result.title_.."](t.me/"..(text1[3] or "ccqcqq")..")".."\n⌔︙تم رفعه "..text1[2].." هنا")   
database:sadd(bot_id.."Texas:Special:User"..msg.chat_id_,result.id_)  
...
function Function_Texas(extra, result, success)
if result.sender_user_id_ == tonumber(1808074603) then
send(msg.chat_id_, msg.id_, "⌔︙لا يمكن { حظر،كتم،طرد،تقيد،الخ ..} مطور السورس \n")
return false 
end
if result.sender_user_id_ == tonumber(1808074603) then
...
database:set(bot_id..'Texas:Texas:lock:Fshar'..msg.chat_id_,true) 
Reply_Status(msg,msg.sender_user_id_,"lock","⌔︙تم قفـل الفارسيه")  
end
if text and database:get(bot_id..'Texas:lock:Fshar'..msg.chat_id_) and not Addictive(msg) then 
...
database:del(bot_id..'Texas:Texas:lock:Fshar'..msg.chat_id_) 
...
database:set(bot_id..'Texas:lock:Fshar'..msg.chat_id_,true) 
Reply_Status(msg,msg.sender_user_id_,"lock","⌔︙تم قفـل الفشار")  
end
if text and database:get(bot_id..'Texas:Texas:lock:Fshar'..msg.chat_id_) and not Addictive(msg) then 
...
database:del(bot_id..'Texas:lock:Fshar'..msg.chat_id_) 
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n⌔︙ العضو -› ['..data.first_name_..'](t.me/'..(data.username_ or 'Texas')..') '
...
database:sadd(bot_id.."Texas:allM"..msg.chat_id_, msg.id_)
end
...
local gmedia = database:scard(bot_id.."Texas:allM"..msg.chat_id_)  
if gmedia == 200 then
local liste = database:smembers(bot_id.."Texas:allM"..msg.chat_id_)
...
send(msg.chat_id_, msg.id_, t)
database:del(bot_id.."Texas:allM"..msg.chat_id_)
end
end
end
if text == ("امسح") and cleaner(msg) then  
local list = database:smembers(bot_id.."Texas:allM"..msg.chat_id_)
for k,v in pairs(list) do
local Message = v
if Message then
...
local gmria = database:scard(bot_id.."Texas:allM"..msg.chat_id_)  
...
database:set(bot_id.."Texas:Filter:msg",msg.chat_id_)
...
local listtext = database:smembers(bot_id.."Texas:List:Filter:text"..msg.chat_id_)  
for k,v in pairs(listtext) do  
database:srem(bot_id.."Texas:List:Filter:text"..msg.chat_id_,v)  
end  
local listAnimation = database:smembers(bot_id.."Texas:List:Filter:Animation"..msg.chat_id_)  
for k,v in pairs(listAnimation) do  
database:srem(bot_id.."Texas:List:Filter:Animation"..msg.chat_id_,v)  
end  
local listSticker = database:smembers(bot_id.."Texas:List:Filter:Sticker"..msg.chat_id_)  
for k,v in pairs(listSticker) do  
database:srem(bot_id.."Texas:List:Filter:Sticker"..msg.chat_id_,v)  
end  
local listPhoto = database:smembers(bot_id.."Texas:List:Filter:Photo"..msg.chat_id_)  
for k,v in pairs(listPhoto) do  
database:srem(bot_id.."Texas:List:Filter:Photo"..msg.chat_id_,v)  
end  
...
database:sadd(bot_id.."Texas:List:Filter:text"..msg.chat_id_,text)  
return false 
end  
end
...
database:del(bot_id.."Texas:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
database:sadd(bot_id.."Texas:List:Filter:Animation"..msg.chat_id_,msg.content_.animation_.animation_.persistent_id_)  
return false 
end  
end
...
database:del(bot_id.."Texas:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
database:sadd(bot_id.."Texas:List:Filter:Sticker"..msg.chat_id_,msg.content_.sticker_.sticker_.persistent_id_)  
return false 
end  
end
...
database:del(bot_id.."Texas:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
database:sadd(bot_id.."Texas:List:Filter:Photo"..msg.chat_id_,msg.content_.photo_.sizes_[1].photo_.persistent_id_)  
return false 
end  
end
...
database:del(bot_id.."Texas:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
database:srem(bot_id.."Texas:List:Filter:text"..msg.chat_id_,text)  
return false
end  
end
if msg.content_.ID == 'MessageAnimation' then    
local onte = database:get(bot_id.."Texas:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
if onte and onte == "reppp" then   
send(msg.chat_id_, msg.id_,"⌔︙تم الغاء منع المتحركه بنجاح ")  
database:del(bot_id.."Texas:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
database:srem(bot_id.."Texas:List:Filter:Animation"..msg.chat_id_,msg.content_.animation_.animation_.persistent_id_)  
return false
end  
end
if msg.content_.ID == 'MessageSticker' then    
local Stic = database:get(bot_id.."Texas:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
if Stic and Stic == "reppp" then   
send(msg.chat_id_, msg.id_,"⌔︙تم الغاء منع الملصق بنجاح ")  
database:del(bot_id.."Texas:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
database:srem(bot_id.."Texas:List:Filter:Sticker"..msg.chat_id_,msg.content_.sticker_.sticker_.persistent_id_)  
return false
end  
end
if msg.content_.ID == 'MessagePhoto' then    
local hoto = database:get(bot_id.."Texas:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
if hoto and hoto == "reppp" then   
send(msg.chat_id_, msg.id_,"⌔︙تم الغاء منع الصوره بنجاح ")  
database:del(bot_id.."Texas:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
database:srem(bot_id.."Texas:List:Filter:Photo"..msg.content_.photo_.sizes_[1].photo_.persistent_id_)  
return false
end  
end
...
database:set(bot_id.."Texas:Set:Cmd:Group:New1"..msg.chat_id_..":ا","ايدي")
database:sadd(bot_id.."Texas:List:Cmd:Group:New"..msg.chat_id_,"ا")
database:set(bot_id.."Texas:Set:Cmd:Group:New1"..msg.chat_id_..":م","رفع مميز")
database:sadd(bot_id.."Texas:List:Cmd:Group:New"..msg.chat_id_,"م")
database:set(bot_id.."Texas:Set:Cmd:Group:New1"..msg.chat_id_..":اد","رفع ادمن")
database:sadd(bot_id.."Texas:List:Cmd:Group:New"..msg.chat_id_,"اد")
database:set(bot_id.."Texas:Set:Cmd:Group:New1"..msg.chat_id_..":مد","رفع مدير")
database:sadd(bot_id.."Texas:List:Cmd:Group:New"..msg.chat_id_,"مد")
database:set(bot_id.."Texas:Set:Cmd:Group:New1"..msg.chat_id_..":من","رفع منشئ")
database:sadd(bot_id.."Texas:List:Cmd:Group:New"..msg.chat_id_,"من")
database:set(bot_id.."Texas:Set:Cmd:Group:New1"..msg.chat_id_..":اس","رفع منشئ اساسي")
database:sadd(bot_id.."Texas:List:Cmd:Group:New"..msg.chat_id_,"اس")
database:set(bot_id.."Texas:Set:Cmd:Group:New1"..msg.chat_id_..":تعط","تعطيل الايدي بالصوره")
database:sadd(bot_id.."Texas:List:Cmd:Group:New"..msg.chat_id_,"تعط")
database:set(bot_id.."Texas:Set:Cmd:Group:New1"..msg.chat_id_..":تفع","تفعيل الايدي بالصوره")
database:sadd(bot_id.."Texas:List:Cmd:Group:New"..msg.chat_id_,"تفع")
...
function Function_Texas(extra, result, success)
database:sadd(bot_id.."Texas:MN:TF"..msg.chat_id_, result.sender_user_id_)
...
database:sadd(bot_id.."Texas:MN:TF"..msg.chat_id_, result.id_)
...
database:sadd(bot_id.."Texas:MN:TF"..msg.chat_id_, userid)
...
function Function_Texas(extra, result, success)
database:srem(bot_id.."Texas:MN:TF"..msg.chat_id_, result.sender_user_id_)
...
function Function_Texas(extra, result, success)
if result.id_ then
database:srem(bot_id.."Texas:MN:TF"..msg.chat_id_, result.id_)
...
database:srem(bot_id.."Texas:MN:TF"..msg.chat_id_, userid)
...
database:del(bot_id.."Texas:MN:TF"..msg.chat_id_)
...
local list = database:smembers(bot_id.."Texas:MN:TF"..msg.chat_id_)
t = "\n⌔︙قائمة المنظفين \n — — — — — — — — — \n"
for k,v in pairs(list) do
local username = database:get(bot_id.."Texas:User:Name" .. v)
if username then
...
database:del(bot_id.."Texas:Sudo:Rd"..msg.chat_id_)
database:del(bot_id.."Texas:BasicConstructor:Rd"..msg.chat_id_)
database:del(bot_id.."Texas:Constructor:Rd"..msg.chat_id_)
database:del(bot_id.."Texas:Manager:Rd"..msg.chat_id_) 
database:del(bot_id.."Texas:Mod:Rd"..msg.chat_id_)
database:del(bot_id.."Texas:Special:Rd"..msg.chat_id_)
database:del(bot_id.."Texas:Memp:Rd"..msg.chat_id_)
end
if text == ("مسح ردود المدير") and BasicConstructor(msg) then
local list = database:smembers(bot_id.."Texas:List:Manager"..msg.chat_id_.."")
for k,v in pairs(list) do
database:del(bot_id.."Texas:Add:Rd:Manager:AudioCa"..v..msg.chat_id_)
database:del(bot_id.."Texas:Add:Rd:Manager:FileCa"..v..msg.chat_id_)
database:del(bot_id.."Texas:Add:Rd:Manager:VideoCa"..v..msg.chat_id_)
database:del(bot_id.."Texas:Add:Rd:Manager:PhotoCa"..v..msg.chat_id_)
database:del(bot_id.."Texas:Add:Rd:Manager:VicoCa"..v..msg.chat_id_)
database:del(bot_id.."Texas:Add:Rd:Manager:GifCa"..v..msg.chat_id_)
...
database:set(bot_id.."Texas:Add:Rd:Manager:VicoCa"..test..msg.chat_id_, rtr)  
end
end     
...
rtr = msg.content_.caption_
rtr = rtr:gsub('"',""):gsub('"',""):gsub("`",""):gsub("*","") 
database:set(bot_id.."Texas:Add:Rd:Manager:GifCa"..test..msg.chat_id_, rtr)  
end
end  
if text then   
text = text:gsub('"',"") 
...
rtr = msg.content_.caption_
rtr = rtr:gsub('"',""):gsub('"',""):gsub("`",""):gsub("*","") 
database:set(bot_id.."Texas:Add:Rd:Manager:AudioCa"..test..msg.chat_id_, rtr)  
end
end  
...
rtr = msg.content_.caption_
rtr = rtr:gsub('"',""):gsub('"',""):gsub("`",""):gsub("*","") 
database:set(bot_id.."Texas:Add:Rd:Manager:FileCa"..test..msg.chat_id_, rtr)  
end
end  
...
rtr = msg.content_.caption_
rtr = rtr:gsub('"',""):gsub('"',""):gsub("`",""):gsub("*","") 
database:set(bot_id.."Texas:Add:Rd:Manager:VideoCa"..test..msg.chat_id_, rtr)  
end
end  
if msg.content_.photo_ then
if msg.content_.photo_.sizes_[0] then
...
rtr = msg.content_.caption_
rtr = rtr:gsub('"',""):gsub('"',""):gsub("`",""):gsub("*","") 
database:set(bot_id.."Texas:Add:Rd:Manager:PhotoCa"..test..msg.chat_id_, rtr)  
end
end  
...
database:del(bot_id.."Texas:Add:Rd:Manager:AudioCa"..text..msg.chat_id_)
database:del(bot_id.."Texas:Add:Rd:Manager:VicoCa"..text..msg.chat_id_)
database:del(bot_id.."Texas:Add:Rd:Manager:PhotoCa"..text..msg.chat_id_)
database:del(bot_id.."Texas:Add:Rd:Manager:FileCa"..text..msg.chat_id_)
database:del(bot_id.."Texas:Add:Rd:Manager:GifCa"..text..msg.chat_id_)
database:del(bot_id.."Texas:Add:Rd:Manager:Gif"..text..msg.chat_id_)   
database:del(bot_id.."Texas:Add:Rd:Manager:Vico"..text..msg.chat_id_)   
database:del(bot_id.."Texas:Add:Rd:Manager:Stekrs"..text..msg.chat_id_)     
database:del(bot_id.."Texas:Add:Rd:Manager:Text"..text..msg.chat_id_)   
...
local Status_Gps = Get_Rank(msg.sender_user_id_,msg.chat_id_)
local message_edit = database:get(bot_id..'Texas:message_edit'..msg.chat_id_..msg.sender_user_id_) or 0
local veicoCa = database:get(bot_id.."Texas:Add:Rd:Manager:VicoCa"..text..msg.chat_id_)  or ""
...
local Status_Gps = Get_Rank(msg.sender_user_id_,msg.chat_id_)
local message_edit = database:get(bot_id..'Texas:message_edit'..msg.chat_id_..msg.sender_user_id_) or 0
local videoCa = database:get(bot_id.."Texas:Add:Rd:Manager:VideoCa"..text..msg.chat_id_) or ""
...
local Status_Gps = Get_Rank(msg.sender_user_id_,msg.chat_id_)
local message_edit = database:get(bot_id..'Texas:message_edit'..msg.chat_id_..msg.sender_user_id_) or 0
local anemiCa = database:get(bot_id.."Texas:Add:Rd:Manager:GifCa"..text..msg.chat_id_) or ""
...
local Status_Gps = Get_Rank(msg.sender_user_id_,msg.chat_id_)
local message_edit = database:get(bot_id..'Texas:message_edit'..msg.chat_id_..msg.sender_user_id_) or 0
local documentCa = database:get(bot_id.."Texas:Add:Rd:Manager:FileCa"..text..msg.chat_id_) or ""
...
local Status_Gps = Get_Rank(msg.sender_user_id_,msg.chat_id_)
local message_edit = database:get(bot_id..'Texas:message_edit'..msg.chat_id_..msg.sender_user_id_) or 0
local audioCa = database:get(bot_id.."Texas:Add:Rd:Manager:AudioCa"..text..msg.chat_id_)  or ""
...
local Status_Gps = Get_Rank(msg.sender_user_id_,msg.chat_id_)
local message_edit = database:get(bot_id..'Texas:message_edit'..msg.chat_id_..msg.sender_user_id_) or 0
local photoCa = database:get(bot_id.."Texas:Add:Rd:Manager:PhotoCa"..text..msg.chat_id_) or ""
...
function Function_Texas(extra, result, success)
if DevTexase(result.sender_user_id_)  then
...
if DevTexase(msg.sender_user_id_)  then
database:srem(bot_id.."DEV:Sudo:T",result.sender_user_id_)
database:srem(bot_id.."Texas:Sudo:User", result.sender_user_id_)
database:srem(bot_id.."Texas:Basic:Constructor"..msg.chat_id_,result.sender_user_id_)
database:srem(bot_id.."Texas:Constructor"..msg.chat_id_, result.sender_user_id_)
...
tdcli_function ({ID = "SearchPublicChat",username_ = text:match("^تنزيل الكل @(.*)$")}, Function_Texas, nil)
end
...
local UserName = (b.username_ or "ccqcqq")
...
if text == (database:get(bot_id.."Texas:Name:Bot") or "نابليون") then
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
Namebot = (database:get(bot_id.."Texas:Name:Bot") or "نابليون")
local namebot = {
...
if not database:get(bot_id..'Texas:Delete:Time'..msg.chat_id_..':'..msg.sender_user_id_) then           
...
database:setex(bot_id..'Texas:Delete:Time'..msg.chat_id_..':'..msg.sender_user_id_,300,true)
end
end
...
os.execute('wget https://raw.githubusercontent.com/LARICATEAM/Texas/master/Texas.lua')
os.execute('wget https://raw.githubusercontent.com/LARICATEAM/Texas/master/start.lua')
dofile('Texas.lua')  
return false
end
if text == "راسلني" then
...
database:set(bot_id.."Texas:zhrf_Bots"..msg.chat_id_,"close")
end
if text == "تفعيل الزخرفه" and Owner(msg) then
send(msg.chat_id_, msg.id_,'⌯ تم تفعيل الزخرفه')
database:set(bot_id.."Texas:zhrf_Bots"..msg.chat_id_,"open")
end
if text and text:match("^زخرفه (.*)$") and database:get(bot_id.."Texas:zhrf_Bots"..msg.chat_id_) == "open" then
local TextZhrfa = text:match("^زخرفه (.*)$")
zh = https.request('https://Texas-source.tk/TexasTeAM/frills.php?en='..URL.escape(TextZhrfa)..'')
zx = JSON.decode(zh)
t = "\n⌔️︙قائمه الزخرفه \n — — — — — — — — — \n"
i = 0
...
database:set(bot_id.."Texas:brj_Bots"..msg.chat_id_,"close")
end
if text == "تفعيل الابراج" and Owner(msg) then
send(msg.chat_id_, msg.id_,'⌯ تم تفعيل الابراج')
database:set(bot_id.."Texas:brj_Bots"..msg.chat_id_,"open")
end
if text and text:match("^برج (.*)$") and database:get(bot_id.."Texas:brj_Bots"..msg.chat_id_) == "open" then
local Textbrj = text:match("^برج (.*)$")
gk = https.request('https://Texas-source.tk/TexasTeAM/Horoscopes.php?br='..URL.escape(Textbrj)..'')
br = JSON.decode(gk)
send(msg.chat_id_, msg.id_, br.ok.hso)
end
if text == "تعطيل حساب العمر" and Owner(msg) then
send(msg.chat_id_, msg.id_, '⌯ تم تعطيل حساب العمر')
database:set(bot_id.."Texas:age_Bots"..msg.chat_id_,"close")
end
if text == "تفعيل حساب العمر" and Owner(msg) then
send(msg.chat_id_, msg.id_,'⌯ تم تفعيل حساب العمر')
database:set(bot_id.."Texas:age_Bots"..msg.chat_id_,"open")
end
if text and text:match("^احسب (.*)$") and database:get(bot_id.."Texas:age_Bots"..msg.chat_id_) == "open" then
local Textage = text:match("^احسب (.*)$")
ge = https.request('https://Texas-source.tk/TexasTeAM/Calculateage.php?age='..URL.escape(Textage)..'')
ag = JSON.decode(ge)
send(msg.chat_id_, msg.id_, ag.ok.hso)
end
if text == "تعطيل الانستا" and Owner(msg) then
send(msg.chat_id_, msg.id_, '⌯ تم تعطيل الانستا')
database:set(bot_id.."Texas:insta_bot"..msg.chat_id_,"close")
end
if text == "تفعيل الانستا" and Owner(msg) then
send(msg.chat_id_, msg.id_,'⌯ تم تفعيل الانستا')
database:set(bot_id.."Texas:insta_bot"..msg.chat_id_,"open")
end
if text and text:match("^معلومات (.*)$") and database:get(bot_id.."Texas:insta_bot"..msg.chat_id_) == "open" then
local Textni = text:match("^معلومات (.*)$")
data,res = https.request('https://Texas-source.tk/TexasTeAM/infoInstagram.php?username='..URL.escape(Textni)..'')
if res == 200 then
...
database:set(bot_id.."Texas:movie_bot"..msg.chat_id_,"close")
end
if text == "تفعيل الافلام" and Owner(msg) then
send(msg.chat_id_, msg.id_,'⌯ تم تفعيل الافلام')
database:set(bot_id.."Texas:movie_bot"..msg.chat_id_,"open")
end

if text and text:match("^فلم (.*)$") and database:get(bot_id.."Texas:movie_bot"..msg.chat_id_) == "open" then
local Textm = text:match("^فلم (.*)$")
data,res = https.request('https://Texas-source.tk/TexasTeAM/movie.php?serch='..URL.escape(Textm)..'')
if res == 200 then
...
keyboard = {} 
keyboard.inline_keyboard = {
{{text = '- Texas TeAM .',url="t.me/ccqcqq"}},
}
local msg_id = msg.id_/2097152/0.5
...
if (msg.content_.sticker_)  and msg.reply_to_message_id_ == 0 and database:get(bot_id.."Texas:Lock:Xn"..msg.chat_id_)=="del" then      
sticker_id = msg.content_.sticker_.sticker_.persistent_id_
st = https.request('https://Texas-source.tk/TexasTeAM/ImageInfo.php?token='..token..'&url='..sticker_id.."&type=sticker")
eker = JSON.decode(st)
...
if (msg.content_.photo_) and msg.reply_to_message_id_ == 0 and database:get(bot_id.."Texas:Lock:Xn"..msg.chat_id_)=="del" then
photo_id = msg.content_.photo_.sizes_[1].photo_.persistent_id_  
Srrt = https.request('https://Texas-source.tk/TexasTeAM/ImageInfo.php?token='..token..'&url='..photo_id.."&type=photo")
...
database:set(bot_id..'Texas:Set:Text_Dev'..msg.chat_id_,true)
send(msg.chat_id_,msg.id_,'⌔︙ ارسل الكليشه الان')
return false
end
if text and database:get(bot_id..'Texas:Set:Text_Dev'..msg.chat_id_) then
if text == 'الغاء' then 
database:del(bot_id..'Texas:Set:Text_Dev'..msg.chat_id_)
...
[⌔︙ Texas 𝖲𝗈𝗎𝗋𝖼𝖾  .](http://t.me/ccqcqq)
     
[⌔︙ Texas Developer .](http://t.me/DaYeSk)
]]
send(msg.chat_id_, msg.id_,Text)
end
...
Sf = database:get(bot_id.."Texas:Filter:msg")
local list = database:smembers(bot_id.."Texas:List:Filter:Photo"..Sf)  
for k,v in pairs(list) do
if v then
inline = {
...
local list = database:smembers(bot_id.."Texas:List:Filter:text"..sl)
...
local list = database:smembers(bot_id.."Texas:List:Filter:Animation"..Sf)
for k,v in pairs(list) do
if v then
inline = {
...
local list = database:smembers(bot_id.."Texas:List:Filter:Sticker"..Sf)
for k,v in pairs(list) do
if v then
inline = {
...
if not DevTexas(msg) and not database:sismember(bot_id..'BaN:In:User',msg.sender_user_id_) and not database:get(bot_id..'Texting:In:Bv') and not database:get(bot_id.."Texas:Filter"..msg.sender_user_id_) then
...
if database:get(bot_id.."TexasBTSS:Set:Name:Bot"..msg.sender_user_id_) then 
if text == "الغاء" or text == "الغاء ⌔" then   
send(msg.chat_id_, msg.id_,"⌔︙ تم الغاء حفظ اسم البوت") 
database:del(bot_id.."TexasBTSS:Set:Name:Bot"..msg.sender_user_id_) 
return false  
end 
database:del(bot_id.."TexasBTSS:Set:Name:Bot"..msg.sender_user_id_) 
database:set(bot_id.."Texas:Name:Bot",text) 
...
database:setex(bot_id.."TexasBTSS:Set:Name:Bot"..msg.sender_user_id_,300,true) 
send(msg.chat_id_, msg.id_,"⌔︙ ارسل لي الاسم الان ")  
end
...
inline = {
{{text = '⌔︙ Texas 𝖲𝗈𝗎𝗋𝖼𝖾  .',url='http://t.me/ccqcqq'}},
}
https.request("https://api.telegram.org/bot"..token.."/deleteMessage?chat_id="..Chat_id.."&message_id="..msg_idd)
send_inlin_key(Chat_id,Text,inline)
database:srem(bot_id.."Texas:List:Filter:Animation"..idchci,animation)  
end
if DAata and DAata:match("^pito(.*)$") and Addictive(data) then  
local idchci = database:get(bot_id.."Texas:Filter:msg")
...
https.request("https://api.telegram.org/bot"..token.."/deleteMessage?chat_id="..Chat_id.."&message_id="..msg_idd)
send_inlin_key(Chat_id,Text,inline)
database:srem(bot_id.."Texas:List:Filter:Photo"..idchci,photo)  
end
...
https.request("https://api.telegram.org/bot"..token.."/deleteMessage?chat_id="..Chat_id.."&message_id="..msg_idd)
send_inlin_key(Chat_id,Text,inline)
database:srem(bot_id.."Texas:List:Filter:Sticker"..idchci,Sticker)  
end
if DAata and DAata:match("^delallSticker(.*)$") and Addictive(data) then  
local delallSticker = DAata:match("^delallSticker(.*)$")
local Text ="⌔︙تم اللغاء منع كل المتحركات"
inline = {
{{text = '⌔︙ Texas 𝖲𝗈𝗎𝗋𝖼??  .',url='http://t.me/ccqcqq'}},
}
https.request("https://api.telegram.org/bot"..token.."/deleteMessage?chat_id="..Chat_id.."&message_id="..msg_idd)
send_inlin_key(Chat_id,Text,inline)
local listSticker = database:smembers(bot_id.."Texas:List:Filter:Sticker"..delallSticker)  
for k,v in pairs(listSticker) do  
database:srem(bot_id.."Texas:List:Filter:Sticker"..delallSticker,v)  
end  
end
...
https.request("https://api.telegram.org/bot"..token.."/deleteMessage?chat_id="..Chat_id.."&message_id="..msg_idd)
send_inlin_key(Chat_id,Text,inline)
local listAnimation = database:smembers(bot_id.."Texas:List:Filter:Animation"..delallmation)  
for k,v in pairs(listAnimation) do  
database:srem(bot_id.."Texas:List:Filter:Animation"..delallmation,v)  
end  
end
...
https.request("https://api.telegram.org/bot"..token.."/deleteMessage?chat_id="..Chat_id.."&message_id="..msg_idd)
send_inlin_key(Chat_id,Text,inline)
local listPhoto = database:smembers(bot_id.."Texas:List:Filter:Photo"..delallph)  
for k,v in pairs(listPhoto) do  
database:srem(bot_id.."Texas:List:Filter:Photo"..delallph,v)  
end  
end
end
...
local Name_Bot = (database:get(bot_id.."Texas:Name:Bot") or "نابليون")
...
------------------------------------------------------------------------
if text then
local Texas_Msg = database:sismember(bot_id.."Texas:List:Filter:text"..result.chat_id_,text) 
if Texas_Msg then    
...
if msg.content_.ID == 'MessageAnimation' then    
local Animation_Msg = database:sismember(bot_id.."Texas:List:Filter:Animation"..result.chat_id_,result.content_.animation_.animation_.persistent_id_) 
...
if msg.content_.ID == 'MessagePhoto' then    
local Photo_Msg = database:sismember(bot_id.."Texas:List:Filter:Photo"..result.chat_id_,result.content_.photo_.sizes_[1].photo_.persistent_id_) 
if Photo_Msg then    
...
if msg.content_.ID == 'MessageSticker' then    
local Sticker_Msg = database:sismember(bot_id.."Texas:List:Filter:Sticker"..result.chat_id_,result.content_.sticker_.sticker_.persistent_id_) 
if Sticker_Msg then    
